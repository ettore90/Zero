...
const PromptPackageCatalog: React.FC = () => {
  ...
  const [githubConnection, setGithubConnection] = React.useState<{ oauthConfigured: boolean; oauth: { connected: boolean }; cliAvailable: boolean; runtimeTokenAvailable: boolean } | null>(null);
